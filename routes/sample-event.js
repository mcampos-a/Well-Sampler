...
router.get('/', ensureAuth,SampleEventController.getSamplingForm) //reads and displays sampling form
// router.get("/:id", ensureAuth, SampleEventController.getSampleEvent); //gets specific sampling event that already happened
router.post('/newSampleEvent', ensureAuth, SampleEventController.createSampleEvent);
